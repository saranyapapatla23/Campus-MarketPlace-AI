...
import { Sparkles, Mail, Lock, User, Building2, ArrowRight, Loader2, Info } from 'lucide-react';
          ...
          <CardContent>
            <Alert className="mb-4 bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-800">
              ...
              <AlertDescription className="text-sm">
                Use your college email address (personal Gmail/Yahoo/etc. accounts aren't accepted).
              </AlertDescription>
            </Alert>
